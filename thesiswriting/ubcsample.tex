...
Note: There may be some use of the active voice in here ('we did such and such'). I am changing it to the passive form. Another option is using the first person. Not a very important manner, but will need to be consistent.
...
Implemented in 5.2K lines of Java entirely using AspectJ 1.7.0 and ajc as the compiler and bytecode weaver. No additional libraries were used.
...
Implemented in 5.7K lines of Java using the JUNG 2.0.1 framework for visualizating and working with graph data.
...
Notes: Have currently tested the tool on RUBiS and jGossip. Justify the choice of each one. RUBiS was chosen as it was a realistic, working application, and mainly as a starting point for our analyses because it is small, easy to understand (for manually checking analyses), and easy to modify where needed.

Notes: jGossip was chosen by searching for large, popular open source Java web applications.
