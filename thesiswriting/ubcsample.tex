...
Notes: jGossip precomputation is going to be on front page load, for the non-tainted elements, as well as things like the forum and group name components. 
NEED TO COLLECT DATA, MAKE FIGURES
...
Notes: May want to elaborate more. This example comes out rather quickly, and the explanation of the results may be a bit brief compared to the explanation of the initial trace graph. Some kind of wrap up statement about what this says about the caching analysis in general might be useful.
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[RUBiS Sell Item Trace]{\label{fig:browseregioncategories} RUBiS Sell Item Trace.}
  \end{center}
\end{figure}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[RUBiS Sell Item Postcomputation Analysis Results]{\label{fig:browseregioncategoriescaching} RUBiS Sell Item Postcomputation Analysis Results.}
  \end{center}
\end{figure}
...
Notes: None present in the RUBiS application
