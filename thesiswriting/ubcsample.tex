...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{fig/arch.eps}
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{fig/arch-2.eps}
    \caption[.]{\label{fig:arch-2} Example partitioning of application.}
  \end{center}
\end{figure}
...
/* This list will be filled with sets, such that each set represents
