...
function getSideEffects(Graph, SideEffectGraph, CallGraph):
	...
	foreach Edge in Graph.getEdges():
		DescendentEdges = CallGraph.getDescendentEdges()
...
foreach Request_SG in RequestSubGraphs:
    UserOutputEdges = getUserOutputEdges(Request_SG)
    DBOutputs = getDBOutputEdges(Request_SG)
    
    foreach DBOutputEdge in DBOutputs:
    	PostCompGraph = Empty Graph
        backwardsExpand(PostCompGraph, DBOutputEdge, UserOutputEdges, Request_SG)
        if (PostCompGraph != {}):
