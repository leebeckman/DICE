...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[]{figs/rubis_BrowseCategories_Numbered.eps}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[RUBiS Browse Categories By Region Precomputation Results]{\label{fig:browseregioncategoriescaching} RUBiS Browse Categories By Region Precomputation Results.}
  \end{center}
\end{figure}
...
NEED TO COLLECT DATA, MAKE FIGURES (HOPEFULLY EASY, DID IT ONCE) 3
...
NEED TO COLLECT DATA, MAKE FIGURES (HOPEFULLY EASY, SORTA DID IT ONCE) 5
...
NEED TO COLLECT DATA, MAKE FIGURES (EASY, ANECDOTAL) 6
