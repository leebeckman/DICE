...
public aspect GeneralTracker {
	...
	// Debug counters
	public int deepScanDone;
	public int deepScanSkip;
...
//        Object[] args = thisJoinPoint.getArgs();
//        
//        TaintLogger.getTaintLogger().log("");
//        	/*
...
//        		IdentityHashMap objTaint = TaintFinder.findTaint(args[i]);
//        		if (objTaint != null && objTaint.size() > 0) {
//        			if (location == null)
//        				location = getStackTracePath();
//    				TaintLogger.getTaintLogger().logCallingObjectArg(location, "EXECUTEOBJECTARG", args[i], objTaint);
//    				Iterator keySet = objTaint.keySet().iterator();
//    				while (keySet.hasNext()) {
//    					Object taintedObject = keySet.next();
...
//			IdentityHashMap objTaint = TaintFinder.findTaint(ret);
//			if (objTaint.size() > 0) {
...
//		}
    ...
    class StackPath {
    	...
    	public StackPath(String destClass, String destMethod, String srcClass, String srcMethod) {
    		...
    		this.deeperStack = new ArrayList();
    	}
