...
public class ServletPrinter
{
	...
	private static LinkedList<String> chattyList = new LinkedList<String>();
	private static LinkedList<String> popularItems = new LinkedList<String>();
  ...
  static void addPopularItem(String item) {
	  popularItems.addLast(item);
	  if (popularItems.size() > 10)
		  popularItems.removeFirst();
  }
  
  static String getPopularItems() {
	  String boxHTML = "";
		 
	  boxHTML += "<div style=\"border:solid 1px black;\">";
	  boxHTML += "<p>Popular Items</p>";
  ...
  static void addChatMessage(String chatMessage) {
//        LinkedList<String> list = ServletPrinter.chattyList;
//        list.addLast(chatMessage);
	  int result = 100;
	  for (int i = 1; i < 1000000; i++) {
		  result += i;
		  result /= i;
	  }
	  chattyList.addLast(chatMessage + " " + result);
	  
	  
	  if (chattyList.size() > 10)
		  chattyList.removeFirst();
  }
  
  static String getChatBox() {
	  String boxHTML = "";
	 
	  boxHTML += "<div style=\"border:solid 1px black;\">";
	  boxHTML += "<p>Chats</p>";
	  for (String item : chattyList) {
		  boxHTML += "<p>" + item + "</p>";
	  }
	  boxHTML += "</div>";
	  boxHTML += "<form action=\"/rubis_servlets/edu.rice.rubis.servlets.SubmitChat\" method=POST>";
	  boxHTML += "	<input type=text size=20 name=chatMessage />";
	  boxHTML += "	<input type=submit value=\"Post\" />";
	  boxHTML += "</form>";
	  return boxHTML;
  }
  ...
  void printHTMLheader(String title)
  {
    ...
    out.println(ServletPrinter.getPopularItems());
    out.println(ServletPrinter.getChatBox());
    ...
    String endDate)
  {
    try
    {
      ...
      ServletPrinter.addPopularItem(itemName + " - " + nbOfBids + " - " + endDate);
    }
    catch (Exception e)
    {
